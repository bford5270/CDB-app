...
function buildPsrSystemPrompt(odcResult) {
  ...
  return [
    ...
    '  Parse as: first 2 digits = MM (month), middle 2 = DD (day), last 2 = YY (year, always 2000s).',
    '  Examples: "070224" → month=07, day=02, year=24 → 2024-07-02',
    '            "043025" → month=04, day=30, year=25 → 2025-04-30',
    '            "110122" → month=11, day=01, year=22 → 2022-11-01',
    '            "061212" → month=06, day=12, year=12 → 2012-06-12',
    ...
    '',
    'From PSR: each FITREP has pay grade, from/to dates, station, 5 trait scores (1-5),',
    'individual average, RS cumulative average (the "R/S CUM" column — typically 3.5–4.5), RS count,',
    ...
    '',
    'THE ONLY WAY to determine promotionRec is the X mark in the 5-column PROMOTION REC grid:',
    '  SP column has X → "SP"',
    '  PR column has X → "PR"',
    '  P column has X → "P"',
    '  MP column has X → "MP"',
    '  EP column has X → "EP"',
    '  No X in any column → "NOB" (not observed, typically CC or AT report type)',
    '',
    'The number in each cell (next to the X or alone) is the count of OTHER officers in the',
    'reporting senior\'s group who received that same recommendation. It is NOT the officer\'s rec.',
    'Example: "P: X  MP: 8  EP: 3" means this officer got P, 8 others got MP, 3 got EP.',
    '',
