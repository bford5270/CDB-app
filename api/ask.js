...
function buildPsrSystemPrompt(odcResult) {
  ...
  return [
    ...
    '',
    'DATE FORMAT FOR startDate/endDate: PSR period dates are 6-digit YYYYMM → convert to YYYY-MM-DD using the 1st of the month.',
    '  "202201" → 2022-01-01  |  "201906" → 2019-06-01  |  "202312" → 2023-12-01',
    '  If the date appears as MM/YYYY or MMYYYY, convert similarly: month and year → YYYY-MM-01.',
